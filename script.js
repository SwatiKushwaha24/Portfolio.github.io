...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load the PDF
    const loadingTask = pdfjsLib.getDocument("assets/Swati's resume (1).pdf");
    ...
    loadingTask.promise.then(function(pdf) {
      ...
      document.getElementById('pdf-viewer-container').innerHTML = `
        <div class="pdf-fallback">
          ...
          <a href="assets/Swati's resume (1).pdf" class="btn" target="_blank">
            <i class="fas fa-external-link-alt"></i> Open PDF
          </a>
          <a href="assets/Swati's resume (1).pdf" download class="btn download-btn">
